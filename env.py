...
# global variable untuk dictionary dengan  koordinat untuk final route
a = {}
...
class Environment(tk.Tk, object):
    def __init__(self):
        ...
        # dictionary untuk menggambar final route
        self.d = {}
        self.f = {}
        ...
        # menulis final dictionary untuk pertama kali
        self.c = True

        # memperlihatkan steps untuk rute terpanjang
        self.longest = 0

        # memperlihatkan step untuk rute terpendek
        self.shortest = 0

    # fungsi untuk membangun env
    def build_environment(self):
        ...
        obstacle11_center = self.o + np.array([pixels * 0, pixels * 10])
        ...
        obstacle19_center = self.o + np.array([pixels * 0, pixels * 18])
        ...
        # Obstacle 20
        # Defining the center of obstacle 2
        obstacle20_center = self.o + np.array([pixels * 1, pixels * 18])
        ...
        obstacle21_center = self.o + np.array([pixels * 2, pixels * 18])
        ...
        obstacle22_center = self.o + np.array([pixels * 3, pixels * 18])
        ...
        obstacle23_center = self.o + np.array([pixels * 4, pixels * 18])
        ...
        obstacle24_center = self.o + np.array([pixels * 4, pixels * 18])
        ...
        obstacle25_center = self.o + np.array([pixels * 5, pixels * 18])
        ...
        obstacle26_center = self.o + np.array([pixels * 6, pixels * 18])
        ...
        obstacle27_center = self.o + np.array([pixels * 7, pixels * 18])
        ...
        obstacle28_center = self.o + np.array([pixels * 8, pixels * 18])
        ...
        obstacle29_center = self.o + np.array([pixels * 9, pixels * 18])
        ...
        obstacle30_center = self.o + np.array([pixels * 10, pixels * 18])
        ...
        obstacle31_center = self.o + np.array([pixels * 11, pixels * 18])
        ...
        obstacle32_center = self.o + np.array([pixels * 12, pixels * 18])
        ...
        obstacle33_center = self.o + np.array([pixels * 13, pixels * 18])
        ...
        obstacle34_center = self.o + np.array([pixels * 14, pixels * 18])
        ...
        obstacle35_center = self.o + np.array([pixels * 15, pixels * 18])
        ...
        obstacle36_center = self.o + np.array([pixels * 16, pixels * 18])
        ...
        obstacle37_center = self.o + np.array([pixels * 17, pixels * 18])
        ...
        obstacle38_center = self.o + np.array([pixels * 18, pixels * 18])
        ...
        obstacle39_center = self.o + np.array([pixels * 19, pixels * 18])
        ...
        obstacle40_center = self.o + np.array([pixels * 20, pixels * 18])
        ...
        obstacle41_center = self.o + np.array([pixels * 21, pixels * 18])
        ...
        obstacle42_center = self.o + np.array([pixels * 22, pixels * 18])
        ...
        obstacle43_center = self.o + np.array([pixels * 23, pixels * 18])
        ...
        obstacle44_center = self.o + np.array([pixels * 24, pixels * 18])
        ...
        obstacle45_center = self.o + np.array([pixels * 25, pixels * 18])
        ...
        obstacle46_center = self.o + np.array([pixels * 26, pixels * 18])
        ...
        obstacle47_center = self.o + np.array([pixels * 27, pixels * 18])
        ...
        obstacle48_center = self.o + np.array([pixels * 28, pixels * 18])
        ...
        obstacle49_center = self.o + np.array([pixels * 29, pixels * 18])
        ...
        obstacle50_center = self.o + np.array([pixels * 30, pixels * 18])
        ...
        # Obstacle 51
        obstacle51_center = self.o + np.array([pixels * 31, pixels * 18])
        ...
        # Obstacle 52
        obstacle52_center = self.o + np.array([pixels * 32, pixels * 18])
        ...
        # Obstacle 53
        obstacle53_center = self.o + np.array([pixels * 33, pixels * 18])
        ...
        # Obstacle 54
        obstacle54_center = self.o + np.array([pixels * 34, pixels * 18])
        ...
        # Obstacle 55
        obstacle55_center = self.o + np.array([pixels * 35, pixels * 18])
        ...
        # Obstacle 56
        obstacle56_center = self.o + np.array([pixels * 36, pixels * 18])
        ...
        # Obstacle 57
        obstacle57_center = self.o + np.array([pixels * 37, pixels * 18])
        ...
        # Obstacle 58
        obstacle58_center = self.o + np.array([pixels * 38, pixels * 18])
        ...
        # Obstacle 59
        obstacle59_center = self.o + np.array([pixels * 39, pixels * 18])
        ...
        # Obstacle 60
        obstacle60_center = self.o + np.array([pixels * 40, pixels * 18])
        ...
        # Obstacle 61
        obstacle61_center = self.o + np.array([pixels * 41, pixels * 18])
        ...
        # Obstacle 62
        obstacle62_center = self.o + np.array([pixels * 42, pixels * 18])
        ...
        # Obstacle 63
        obstacle63_center = self.o + np.array([pixels * 43, pixels * 18])
        ...
        # Obstacle 64
        obstacle64_center = self.o + np.array([pixels * 44, pixels * 18])
        ...
        # Obstacle 65
        obstacle65_center = self.o + np.array([pixels * 45, pixels * 18])
        ...
        # Obstacle 66
        obstacle66_center = self.o + np.array([pixels * 46, pixels * 18])
        ...
        # Obstacle 67
        obstacle67_center = self.o + np.array([pixels * 47, pixels * 18])
        ...
        # Obstacle 68
        obstacle68_center = self.o + np.array([pixels * 48, pixels * 18])
        ...
        # Obstacle 69
        obstacle69_center = self.o + np.array([pixels * 48, pixels * 18])
        ...
        # Obstacle 70
        obstacle70_center = self.o + np.array([pixels * 49, pixels * 18])
        ...
        # Obstacle 71
        obstacle71_center = self.o + np.array([pixels * 50, pixels * 18])
        ...
        #Obstacle 72
        obstacle72_center = self.o + np.array([pixels * 1, pixels * 10])
        ...
        #Obstacle 73
        obstacle73_center = self.o + np.array([pixels * 2, pixels * 10])
        ...
        #Obstacle 74
        obstacle74_center = self.o + np.array([pixels * 3, pixels * 10])
        ...
        #Obstacle 75
        obstacle75_center = self.o + np.array([pixels * 3, pixels * 9])
        ...
        #Obstacle 76
        obstacle76_center = self.o + np.array([pixels * 3, pixels * 8])
        ...
        #Obstacle 77
        obstacle77_center = self.o + np.array([pixels * 3, pixels * 7])
        ...
        #Obstacle 78
        obstacle78_center = self.o + np.array([pixels * 3, pixels * 5])
        ...
        #Obstacle 79
        obstacle79_center = self.o + np.array([pixels * 2, pixels * 5])
        ...
        #Obstacle 80
        obstacle80_center = self.o + np.array([pixels * 1, pixels * 5])
        ...
        #Obstacle 81   
        obstacle81_center = self.o + np.array([pixels * 3, pixels * 3])
        ...
        #Obstacle 82
        obstacle82_center = self.o + np.array([pixels * 4, pixels * 3])
        ...
        #Obstacle 83  
        obstacle83_center = self.o + np.array([pixels * 4, pixels * 1])
        ...
        #Obstacle 84  
        obstacle84_center = self.o + np.array([pixels * 4, pixels * 2])
        ...
        #Obstacle 85
        obstacle85_center = self.o + np.array([pixels * 5, pixels *3])
        ...
        #Obstacle 86   
        obstacle86_center = self.o + np.array([pixels * 5, pixels * 5])
        ...
        # #Obstacle 87
        # obstacle87_center = self.o + np.array([pixels * 5, pixels * 6])
        ...
        #Obstacle 88
        obstacle88_center = self.o + np.array([pixels * 5, pixels * 7])
        ...
        #Obstacle 89
        obstacle89_center = self.o + np.array([pixels * 5, pixels * 8])
        ...
        #Obstacle 90
        obstacle90_center = self.o + np.array([pixels * 5, pixels * 9])
        ...
        #Obstacle 91
        obstacle91_center = self.o + np.array([pixels * 5, pixels * 10])
        ...
        #Obstacle 92
        obstacle92_center = self.o + np.array([pixels * 7, pixels * 10])
        ...
        #Obstacle 93
        obstacle93_center = self.o + np.array([pixels * 8, pixels * 10])
        ...
        #Obstacle 94   
        obstacle94_center = self.o + np.array([pixels * 8, pixels * 9])
        ...
        #Obstacle 95
        obstacle95_center = self.o + np.array([pixels * 8, pixels * 8])
        ...
        #Obstacle 96 
        obstacle96_center = self.o + np.array([pixels * 8, pixels * 7])
        ...
        #Obstacle 97
        obstacle97_center = self.o + np.array([pixels * 8, pixels * 6])
        ...
        #Obstacle 98
        obstacle98_center = self.o + np.array([pixels * 8, pixels * 5])
        ...
        #Obstacle 99
        obstacle99_center = self.o + np.array([pixels * 8, pixels * 4])
        ...
        #Obstacle 100
        obstacle100_center = self.o + np.array([pixels * 8, pixels * 3])
        ...
        #Obstacle 101
        obstacle101_center = self.o + np.array([pixels * 8, pixels * 2])
        ...
        #Obstacle 102
        obstacle102_center = self.o + np.array([pixels * 8, pixels * 1])
        ...
        #Obstacle 103
        obstacle103_center = self.o + np.array([pixels * 6, pixels * 5])
        ...
        #Obstacle 104
        obstacle104_center = self.o + np.array([pixels * 7, pixels * 5])
        ...
        #Obstacle 105
        obstacle105_center = self.o + np.array([pixels * 4, pixels * 0])
        ...
        #Obstacle 106
        obstacle106_center = self.o + np.array([pixels * 8, pixels * 0])
        ...
        #Obstacle 107
        obstacle107_center = self.o + np.array([pixels * 9, pixels * 10])
        ...
        #Obstacle 108
        obstacle108_center = self.o + np.array([pixels * 12, pixels * 10])
        ...
        #Obstacle 109   
        obstacle109_center = self.o + np.array([pixels * 13, pixels * 10])
        ...
        #Obstacle 110
        obstacle110_center = self.o + np.array([pixels * 14, pixels * 10])
        ...
        #Obstacle 111
        obstacle111_center = self.o + np.array([pixels * 15, pixels * 10])
        ...
        #Obstacle 112
        obstacle112_center = self.o + np.array([pixels * 16, pixels * 10])
        ...
        #Obstacle 113 
        obstacle113_center = self.o + np.array([pixels * 17, pixels * 10])
        ...
        #Obstacle 114
        obstacle114_center = self.o + np.array([pixels * 18, pixels * 10])
        ...
        #Obstacle 115
        obstacle115_center = self.o + np.array([pixels * 19, pixels * 10])
        ...
        #Obstacle 116
        obstacle116_center = self.o + np.array([pixels * 20, pixels * 10])
        ...
        #Obstacle 117
        obstacle117_center = self.o + np.array([pixels * 21, pixels * 10])
        ...
        #Obstacle 118 
        obstacle118_center = self.o + np.array([pixels * 22, pixels * 10])
        ...
        #Obstacle 119
        obstacle119_center = self.o + np.array([pixels * 23, pixels * 10])
        ...
        #Obstacle 120
        obstacle120_center = self.o + np.array([pixels * 24, pixels * 10])
        ...
        #Obstacle 121
        obstacle121_center = self.o + np.array([pixels * 25, pixels * 10])
        ...
        #Obstacle 122
        obstacle122_center = self.o + np.array([pixels * 26, pixels * 10])
        ...
        #Obstacle 123
        obstacle123_center = self.o + np.array([pixels * 27, pixels * 10])
        ...
        #Obstacle 124
        obstacle124_center = self.o + np.array([pixels * 28, pixels * 10])
        ...
        #Obstacle 125    
        obstacle125_center = self.o + np.array([pixels * 31, pixels * 10])
        ...
        #Obstacle 126
        obstacle126_center = self.o + np.array([pixels * 32, pixels * 10])
        ...
        #Obstacle 127
        obstacle127_center = self.o + np.array([pixels * 33, pixels * 10])
        ...
        #Obstacle 128
        obstacle128_center = self.o + np.array([pixels * 34, pixels * 10])
        ...
        #Obstacle 129
        obstacle129_center = self.o + np.array([pixels * 35, pixels * 10])
        ...
        #Obstacle 130
        obstacle130_center = self.o + np.array([pixels * 36, pixels * 10])
        ...
        #Obstacle 131     
        obstacle131_center = self.o + np.array([pixels * 37, pixels * 10])
        ...
        #Obstacle 132  
        obstacle132_center = self.o + np.array([pixels * 38, pixels * 10])
        ...
        #Obstacle 133
        obstacle133_center = self.o + np.array([pixels * 39, pixels * 10])
        ...
        #Obstacle 134    
        obstacle134_center = self.o + np.array([pixels * 40, pixels * 10])
        ...
        #Obstacle 135
        obstacle135_center = self.o + np.array([pixels * 43, pixels * 10])
        ...
        #Obstacle 136
        obstacle136_center = self.o + np.array([pixels * 44, pixels * 10])
        ...
        #Obstacle 137 
        obstacle137_center = self.o + np.array([pixels * 44, pixels * 9])
        ...
        #Obstacle 138  
        obstacle138_center = self.o + np.array([pixels * 44, pixels * 8])
        ...
        #Obstacle 139  
        obstacle139_center = self.o + np.array([pixels * 44, pixels * 7])
        ...
        #Obstacle 140
        obstacle140_center = self.o + np.array([pixels * 44, pixels * 6])
        ...
        #Obstacle 141
        obstacle141_center = self.o + np.array([pixels * 44, pixels * 5])
        ...
        #Obstacle 142
        obstacle142_center = self.o + np.array([pixels * 44, pixels * 4])
        ...
        #Obstacle 143  
        obstacle143_center = self.o + np.array([pixels * 44, pixels * 3])
        ...
        #Obstacle 144
        obstacle144_center = self.o + np.array([pixels * 44, pixels * 2])
        ...
        #Obstacle 145
        obstacle145_center = self.o + np.array([pixels * 44, pixels * 1])
        ...
        #Obstacle 146
        obstacle146_center = self.o + np.array([pixels * 44, pixels * 0])
        ...
        #Obstacle 147 
        obstacle147_center = self.o + np.array([pixels * 32, pixels * 9])
        ...
        #Obstacle 148
        obstacle148_center = self.o + np.array([pixels * 32, pixels * 8])
        ...
        #Obstacle 149
        obstacle149_center = self.o + np.array([pixels * 32, pixels * 7])
        ...
        #Obstacle 150
        obstacle150_center = self.o + np.array([pixels * 32, pixels * 6])
        ...
        #Obstacle 151
        obstacle151_center = self.o + np.array([pixels * 32, pixels * 5])
        ...
        #Obstacle 152   
        obstacle152_center = self.o + np.array([pixels * 32, pixels * 4])
        ...
        #Obstacle 153
        obstacle153_center = self.o + np.array([pixels * 32, pixels * 3])
        ...
        #Obstacle 154
        obstacle154_center = self.o + np.array([pixels * 32, pixels * 2])
        ...
        #Obstacle 155  
        obstacle155_center = self.o + np.array([pixels * 32, pixels * 1])
        ...
        #Obstacle 156
        obstacle156_center = self.o + np.array([pixels * 32, pixels * 0])
        ...
        #Obstacle 157
        obstacle157_center = self.o + np.array([pixels * 20, pixels * 9])
        ...
        #Obstacle 158
        obstacle158_center = self.o + np.array([pixels * 20, pixels * 8])
        ...
        #Obstacle 159
        obstacle159_center = self.o + np.array([pixels * 20, pixels * 7])
        ...
        #Obstacle 160
        obstacle160_center = self.o + np.array([pixels * 20, pixels * 6])
        ...
        #Obstacle 161
        obstacle161_center = self.o + np.array([pixels * 20, pixels * 5])
        ...
        #Obstacle 162
        obstacle162_center = self.o + np.array([pixels * 20, pixels * 4])
        ...
        #Obstacle 163
        obstacle163_center = self.o + np.array([pixels * 20, pixels * 3])
        ...
        #Obstacle 164
        obstacle164_center = self.o + np.array([pixels * 20, pixels * 2])
        ...
        #Obstacle 165
        obstacle165_center = self.o + np.array([pixels * 20, pixels * 1])
        ...
        #Obstacle 166
        obstacle166_center = self.o + np.array([pixels * 20, pixels * 0])
        ...
        #Obstacle 167
        obstacle167_center = self.o + np.array([pixels * 5, pixels * 17])
        ...
        #Obstacle 168
        obstacle168_center = self.o + np.array([pixels * 5, pixels * 16])
        ...
        #Obstacle 169
        obstacle169_center = self.o + np.array([pixels * 5, pixels * 15])
        ...
        #Obstacle 170
        obstacle170_center = self.o + np.array([pixels * 5, pixels * 14])
        ...
        #Obstacle 171
        obstacle171_center = self.o + np.array([pixels * 5, pixels * 13])
        ...
        #Obstacle 172
        obstacle172_center = self.o + np.array([pixels * 6, pixels * 13])
        ...
        #Obstacle 173
        obstacle173_center = self.o + np.array([pixels * 7, pixels * 13])
        ...
        #Obstacle 174
        obstacle174_center = self.o + np.array([pixels * 8, pixels * 13])
        ...
        #Obstacle 175
        obstacle175_center = self.o + np.array([pixels * 9, pixels * 13])
        ...
        #Obstacle 176
        obstacle176_center = self.o + np.array([pixels * 10, pixels * 13])
        ...
        #Obstacle 177
        obstacle177_center = self.o + np.array([pixels * 11, pixels * 13])
        ...
        #Obstacle 178
        obstacle178_center = self.o + np.array([pixels * 12, pixels * 13])
        ...
        #Obstacle 179
        obstacle179_center = self.o + np.array([pixels * 14, pixels * 13])
        ...
        #Obstacle 180
        obstacle180_center = self.o + np.array([pixels * 15, pixels * 13])
        ...
        #Obstacle 181
        obstacle181_center = self.o + np.array([pixels * 16, pixels * 13])
        ...
        #Obstacle 182
        obstacle182_center = self.o + np.array([pixels * 19, pixels * 13])
        ...
        #Obstacle 183
        obstacle183_center = self.o + np.array([pixels * 20, pixels * 13])
        ...
        #Obstacle 184
        obstacle184_center = self.o + np.array([pixels * 21, pixels * 13])
        ...
        #Obstacle 185
        obstacle185_center = self.o + np.array([pixels * 22, pixels * 13])
        ...
        #Obstacle 186
        obstacle186_center = self.o + np.array([pixels * 23, pixels * 13])
        ...
        #Obstacle 187
        obstacle187_center = self.o + np.array([pixels * 24, pixels * 13])
        ...
        #Obstacle 188
        obstacle188_center = self.o + np.array([pixels * 27, pixels * 13])
        ...
        #Obstacle 188
        obstacle188_center = self.o + np.array([pixels * 28, pixels * 13])
        ...
        #Obstacle 189
        obstacle189_center = self.o + np.array([pixels * 28, pixels * 14])
        ...
        #Obstacle 190
        obstacle190_center = self.o + np.array([pixels * 28, pixels * 15])
        ...
        #Obstacle 191
        obstacle191_center = self.o + np.array([pixels * 28, pixels * 16])
        ...
        #Obstacle 192
        obstacle192_center = self.o + np.array([pixels * 28, pixels * 17])
        ...
        #Obstacle 193  
        obstacle193_center = self.o + np.array([pixels * 15, pixels * 14])
        ...
        #Obstacle 194
        obstacle194_center = self.o + np.array([pixels * 15, pixels * 15])
        ...
        #Obstacle 195
        obstacle195_center = self.o + np.array([pixels * 15, pixels * 16])
        ...
        #Obstacle 196
        obstacle196_center = self.o + np.array([pixels * 15, pixels * 17])
        ...
        #Obstacle 197
        obstacle197_center = self.o + np.array([pixels * 30, pixels * 14])
        ...
        #Obstacle 198  
        obstacle198_center = self.o + np.array([pixels * 31, pixels * 14])
        ...
        #Obstacle 199 
        obstacle199_center = self.o + np.array([pixels * 32, pixels * 14])
        ...
        #Obstacle 200
        obstacle200_center = self.o + np.array([pixels * 33, pixels * 14])
        ...
        #Obstacle 201
        obstacle201_center = self.o + np.array([pixels * 34, pixels * 14])
        ...
        #Obstacle 202
        obstacle202_center = self.o + np.array([pixels * 35, pixels * 14])
        ...
        #Obstacle 203
        obstacle203_center = self.o + np.array([pixels * 35, pixels * 15])
        ...
        #Obstacle 204   
        obstacle204_center = self.o + np.array([pixels * 35, pixels * 16])
        ...
        #Obstacle 205    
        obstacle205_center = self.o + np.array([pixels * 35, pixels * 17])
        ...
        #Obstacle 206    
        obstacle206_center = self.o + np.array([pixels * 6, pixels * 8])
        ...
        #Obstacle 207    
        obstacle207_center = self.o + np.array([pixels * 7, pixels * 8])
        ...
        agent_center = self.o + np.array([pixels * 35, pixels * 5])
        ...
        flag_center = self.o + np.array([pixels * 0, pixels * 12])
        # Building the flag
